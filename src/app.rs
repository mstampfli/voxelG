...
pub struct App {
    ...
    // Click queue. Consumed at the top of RedrawRequested after camera state
    // for the about-to-render frame is settled, so the raycast direction
    // matches the rendered crosshair.
